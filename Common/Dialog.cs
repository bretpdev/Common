...
namespace Common
{
    public class Dialog
    {
        ...
        public bool YesNo(string confirmationMessage, string caption = "Confirm", IWin32Window owner = null) =>
             Box(confirmationMessage, caption, MessageBoxButtons.YesNo, owner) == DialogResult.Yes;
        ...
        public bool OkCancel(string alertMessage, string caption = "Alert", IWin32Window owner = null) =>
             Box(alertMessage, caption, MessageBoxButtons.OKCancel, owner) == DialogResult.OK;
